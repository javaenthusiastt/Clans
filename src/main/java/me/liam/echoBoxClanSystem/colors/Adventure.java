...
public class Adventure {
    ...
    /**
     * Parses a string with both Minecraft legacy format (both § and &) and MiniMessage into a Component.
     * First converts legacy format to MiniMessage compatible format, then parses.
     *
     * @param input the input string that may contain both legacy color codes and MiniMessage tags
